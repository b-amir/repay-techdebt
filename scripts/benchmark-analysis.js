#!/usr/bin/env node
import { AnalysisCache, checkBudget } from "./lib/analysis-cache.js";
...
async function run() {
  ...
  const sizes = [
    { name: "1k", files: Array.from({length: 1000}, (_, i) => `src/file_${i}.js`), budgetMs: 500 },
    { name: "10k", files: Array.from({length: 10000}, (_, i) => `src/file_${i}.js`), budgetMs: 2000 },
  ];

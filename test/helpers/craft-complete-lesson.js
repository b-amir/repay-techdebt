...
sectionRoles:
  workedPath: Where the route asks permission
  pitfall: Hiding the button is not the rule
  check: Predict a direct-route bypass
learningMoments:
...
## Where the route asks permission
...
## Hiding the button is not the rule

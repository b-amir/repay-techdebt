...
mapAnswers: >-
  ...
  records settlement?
sectionRoles:
  workedPath: Follow capturePayment into settle
  pitfall: Why capture does not own settled
  check: Debug a missing status field
---
...
## Follow capturePayment into settle
...
## Why capture does not own settled
